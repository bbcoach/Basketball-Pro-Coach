...
export const STARTER_PLAYS = [
  ...
  {
    id: 'sp-horns-flex', name: 'Horns flex', desc: 'Reverse to the wing; the strong elbow drops to flex-screen the weak wing across the baseline, then gets down-screened himself to pop back out.',
    view: 'half', steps: 3,
    players: [
      { id: 'o1', team: 'off', label: '1', x: 750, y: 1180, acts: [] },
      { id: 'o2', team: 'off', label: '2', x: 110, y: 760, acts: [{ type: 'cut', step: 2, pts: [{ x: 350, y: 450 }, { x: 650, y: 250 }, { x: 880, y: 220 }] }] },
      { id: 'o3', team: 'off', label: '3', x: 1390, y: 760, acts: [] },
      { id: 'o4', team: 'off', label: '4', x: 520, y: 560, acts: [{ type: 'screen', step: 3, pts: [{ x: 900, y: 450 }] }] },
      { id: 'o5', team: 'off', label: '5', x: 980, y: 560, acts: [{ type: 'screen', step: 2, pts: [{ x: 950, y: 300 }] }, { type: 'cut', step: 3, pts: [{ x: 1050, y: 500 }, { x: 1020, y: 750 }] }] },
    ],
    ball: { x: 800, y: 1230, acts: [{ type: 'pass', step: 1, pts: [{ x: 1390, y: 760 }] }] },
  },
