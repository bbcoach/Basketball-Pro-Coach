...
import { raised, keycap, chipSurface, field, ACCENT2 } from '../../theme'
        ...
        {picks.map((pl) => {
          ...
          return (
            <div
              ...
              style={{ flex: 'none', padding: '7px 10px', borderRadius: 12, fontSize: 11.5, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap', background: on ? 'rgba(255,255,255,.11)' : 'rgba(255,255,255,.05)', color: on ? '#fff' : 'rgba(255,255,255,.6)', border: '1px solid ' + (on ? ACCENT2 : 'rgba(255,255,255,.09)') }}
            >
              {pl.name}
            </div>
          )
