...
import { COND, keycap, ACCENT2, INK2 } from '../../../theme'
    ...
    return (
      <div
        ...
        style={{
          ...
          background: active ? ACCENT2 : 'rgba(255,255,255,.06)', color: active ? INK2 : 'rgba(255,255,255,.7)',
    ...
    <div style={{ position: 'absolute', inset: 0, zIndex: 95, background: 'rgba(6,6,8,.72)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 26 }}>
      <div style={{ width: '100%', maxWidth: 330, background: '#141417', border: '1px solid rgba(255,255,255,.11)', borderRadius: 18, padding: 18, boxShadow: '0 24px 60px rgba(0,0,0,.6)' }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '11px 12px', borderRadius: 12, border: '1px solid rgba(255,255,255,.16)', background: 'rgba(255,255,255,.06)', color: '#fff', fontSize: 14, outline: 'none' }}
        />
