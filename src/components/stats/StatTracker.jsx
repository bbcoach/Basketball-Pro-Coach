      ...
      {isGame && (
        <div style={{ display: 'flex', gap: 6 }}>
          <div
            ...
            style={{ ...centred, flex: 'none', padding: '8px 11px', borderRadius: 12, fontSize: 12, fontWeight: 600, cursor: 'pointer', background: game.home === 'home' ? 'rgba(255,255,255,.11)' : 'rgba(255,255,255,.06)', color: game.home === 'home' ? '#fff' : 'rgba(255,255,255,.6)', border: '1px solid ' + (game.home === 'home' ? ACCENT : 'transparent') }}
          >
            Home
          </div>
          <div
            onClick={() => setGameHome(game.home === 'away' ? '' : 'away')}
            style={{ ...centred, flex: 'none', padding: '8px 11px', borderRadius: 12, fontSize: 12, fontWeight: 600, cursor: 'pointer', background: game.home === 'away' ? 'rgba(255,255,255,.11)' : 'rgba(255,255,255,.06)', color: game.home === 'away' ? '#fff' : 'rgba(255,255,255,.6)', border: '1px solid ' + (game.home === 'away' ? ACCENT : 'transparent') }}
          >
            Away
          </div>
          <input
