    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 998, background: 'rgba(6,6,8,.74)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 22 }}>
      <div style={{ width: '100%', maxWidth: 340, background: '#141417', border: '1px solid rgba(255,255,255,.11)', borderRadius: 18, padding: 18, boxShadow: '0 24px 60px rgba(0,0,0,.6)' }}>
        ...
        <textarea
          ...
          style={{ width: '100%', padding: '10px 11px', marginBottom: 8, borderRadius: 12, border: '1px solid rgba(255,255,255,.14)', background: 'rgba(255,255,255,.06)', color: '#fff', fontSize: 11, fontFamily: 'monospace', outline: 'none', resize: 'none' }}
        />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div onClick={submitImport} style={{ padding: 12, borderRadius: 12, background: ACCENT, color: '#101012', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', textAlign: 'center' }}>Import</div>
          <div onClick={closeImport} style={{ padding: 10, borderRadius: 12, background: 'transparent', color: 'rgba(255,255,255,.55)', fontSize: 12.5, fontWeight: 600, cursor: 'pointer', textAlign: 'center' }}>Cancel</div>
        </div>
      </div>
    </div>
  )
